    ...
    <div style={{ maxWidth: 680, margin: "0 auto", padding: isMobile ? "24px 16px" : "48px 24px" }}>
      ...
      <div style={{ marginBottom: 40 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 12 }}>
          ...
          <h1 style={{ fontFamily: "var(--font-heading)", fontSize: isMobile ? 28 : 36, color: "#000000", margin: 0 }}>
            TEST FAUCET
          </h1>
        </div>
        ...
        {TOKENS.map((token, i) => (
          <div
            ...
            style={{
              ...
              /* On mobile: stack vertically; on desktop: row */
              display: "flex",
          ...
          >
            ...
            {/* Mint button — full width on mobile, fixed width on desktop */}
